  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-950 text-white overflow-x-hidden overflow-y-auto">
        ...
        options={{
          ...
          particles: {
            ...
            number: {
              ...
              value: typeof window !== 'undefined' && window.innerWidth < 640 ? 30 : 50,
            },
            opacity: {
              value: 0.3,
            },
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-0 left-0 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-amber-600/10 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-[350px] h-[350px] sm:w-[600px] sm:h-[600px] bg-yellow-600/10 rounded-full blur-[120px] translate-x-1/3 translate-y-1/3"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col min-h-full">
        {/* Hero Section */}
        <div className="flex-1 flex flex-col items-center mt-16 sm:mt-24 md:mt-[140px] mb-12 sm:mb-20 justify-center px-4 sm:px-6 py-8 sm:py-12 md:py-20 text-center max-w-6xl mx-auto w-full">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="pt-6 sm:pt-8 pb-8 sm:pb-12">
              ...
              <p className="mt-3 sm:mt-4 text-xs sm:text-sm text-gray-500 flex items-center justify-center gap-2 px-2">
                ...
                <span className="text-center">Requires Microphone & Camera Access</span>
              </p>
            </div>
          </div>
        </div>
           ...
           <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-amber-900/20 to-gray-900/40 border border-amber-500/20 relative overflow-hidden shadow-lg shadow-amber-900/10">
                   <div className="absolute top-0 right-0 p-2 sm:p-4 opacity-10">
                      {/* Chip/Processor Icon */}
                      <svg className="w-20 h-20 sm:w-32 sm:h-32 text-amber-400" fill="currentColor" viewBox="0 0 24 24">
                   ...
                   <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                     <li className="flex items-start gap-2 sm:gap-3">
                        <div className="mt-1 bg-amber-500/20 p-1 sm:p-1.5 rounded text-amber-400 flex-shrink-0">
                          {/* Eye/Vision Icon */}
                        ...
                        <div>
                          <strong className="text-white block text-xs sm:text-sm">SmolVLM-256M</strong>
                     ...
                     <li className="flex items-start gap-2 sm:gap-3">
                        <div className="mt-1 bg-yellow-500/20 p-1 sm:p-1.5 rounded text-yellow-400 flex-shrink-0">
                          {/* Chat/Language Icon */}
                          <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                          <strong className="text-white block text-xs sm:text-sm">TinyLlama-1.1B-Chat</strong>
